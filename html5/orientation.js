...
function on_device_motion(e)
{
	...
	document.getElementById("id_rot_x").innerHTML = Math.round(Math.atan(acc_x/acc_y)*100)/100;
	document.getElementById("id_rot_y").innerHTML = Math.round(Math.atan(acc_y/acc_x)*100)/100;
}
